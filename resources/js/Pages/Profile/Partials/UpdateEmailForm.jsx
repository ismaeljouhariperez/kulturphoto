                ...
                {mustVerifyEmail && user.email_verified_at === null && (
                    <div>
                        <p className="text-sm mt-2 text-gray-800">
                            Votre adresse mail n'a pas encore été vérifiée.
                            <Link
                            ...
                            >
                                Cliquez ici pour recevoir un nouveau lien de vérification.
                            </Link>
                        </p>

                        {status === 'verification-link-sent' && (
                            <div className="mt-2 font-medium text-sm text-green-600">
                                Un lien de vérification a été envoyé à l'adresse mail que vous avez fournie lors de votre inscription.
                            </div>
                        )}
                    </div>
                )}
